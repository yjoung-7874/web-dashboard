  ...
  return html.Div([
    ...
    html.Div([
      ...
      html.Div([
        ...
        ], className="eight columns middle-aligned", style={"color": "#696969"}, ),
      ], className="row ", ),
      # Row 3
      html.Br([]),
      html.Div([
        html.Div([
          html.H6( ["Equity characteristics as of 01/31/2018"], className="subtitle padded", ),
      ...
      html.Div([
        html.Div([
          html.H6( ["Equity sector diversification"], className="subtitle padded", ),
