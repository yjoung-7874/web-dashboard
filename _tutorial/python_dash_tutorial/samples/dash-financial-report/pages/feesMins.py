    ...
    html.Div([
      ...
      html.Div([
        html.Div([
          ...
          html.Div([
            html.Div([
              html.Strong(["Account service fee"], style={"color": "#515151"},)
            ], className="three columns right-aligned",),
            html.Div([
              html.Strong([
              ...
              html.Br([]),
              html.Strong(["SIMPLE IRAs"], style={"color": "#515151"},),
              html.P([
              ...
              html.Br([]),
              html.Strong(["403(b)(7) plans"], style={"color": "#515151"}, ),
              html.P([
              ...
              html.Br([]), 
              html.Strong(["Individual 401(k) plans"], style={"color": "#515151"},),
              html.P([
