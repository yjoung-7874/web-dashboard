...
df_business = pd.read_csv(DATA_PATH.joinpath("df_business.csv"))
...
def create_layout(app):
  return html.Div([
    ...
    html.Div([
      ...
      html.Div([
        html.Div([
          html.H6( ["Current Prices"], className="subtitle padded" ),
      ...
      html.Div([
        html.Div([
          html.H6(["Average annual returns--updated monthly as of 02/28/2018"], className="subtitle padded",),
          html.Div(
      ...
      html.Div([
        html.Div([
          html.H6(["Recent investment returns"],className="subtitle padded",),
